...
export default function DraftsNewLandingPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 py-4">
      <header className="space-y-1">
        <h1 className="text-2xl font-bold text-slate-800">Drafts</h1>
        <p className="muted-copy">
          Drafts are now called Storyboards — the long-form draft we generate from your selected
          angle.
        </p>
      </header>
